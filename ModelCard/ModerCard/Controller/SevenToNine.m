...
#import "ImagesView.h"
@interface SevenToNine ()<UITableViewDataSource, UITableViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,ImagesViewDelegae>
@property (nonatomic,strong) ImagesView * selectImages;
@property (nonatomic,strong) NSArray * modelArray;
@end

@implementation SevenToNine{
    UIImageView *imageView;
    NSDictionary *_ModelDict;
}
-(NSArray *)modelArray{
    if (!_modelArray) {
        NSString *plistPath = [[NSBundle mainBundle]pathForResource:@"a2Model" ofType:@"plist"];
