...
#import "ImagesView.h"
@interface TenToThirteen ()<UITableViewDataSource, UITableViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,ImagesViewDelegae>
@property (nonatomic,strong) ImagesView * selectImages;
@end

@implementation TenToThirteen{
