...
@interface FiveToSix ()<UITableViewDataSource, UITableViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,ImagesViewDelegae>
@property (nonatomic,strong) ImagesView * selectImages;
@property (nonatomic,strong) NSArray * modelArray;
@end

@implementation FiveToSix{
    UIImageView *imageView;
    NSDictionary *_ModelDict;
}
-(NSArray *)modelArray{
    if (!_modelArray) {
        NSString *plistPath = [[NSBundle mainBundle]pathForResource:@"a3Model" ofType:@"plist"];
